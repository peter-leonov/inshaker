...
class Ingredient < Inshaker::Entity
  module Config
    ...
    DB_JS          = Inshaker::HTDOCS_DIR + "db/ingredients/ingredients.js"
    DB_JS_GROUPS   = Inshaker::HTDOCS_DIR + "db/ingredients/groups.js"
    DB_JS_TAGS     = Inshaker::HTDOCS_DIR + "db/ingredients/tags.js"
