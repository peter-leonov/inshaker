var bars_db =
{
	...
	[
		...
		{name: 'Denis Simachev Shop & Bar', format: ['спокойная', 'умная', 'книжная'], name_eng: 'Denis Simachev Shop & Bar', point: [55.915,37.397], id: 'denis-simachev-shop-bar', cocktails: ['Александр', 'Мохито'], recommended: ['Александр', 'Мохито'], recommended: ['Александр', 'Мохито']},
