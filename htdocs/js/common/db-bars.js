...
({
	...
	'Санкт-Петербург':
	[
		{name: '01 кафе', format: ['уютная', 'пахнет кофе'], name_eng: '01 Cafe', point: [59.95,30.39], carte: ['Александр', 'Мохито'], recs: ['Александр', 'Мохито']},
		{name: 'A.v.e.n.u.e', format: ['уютная', 'накуренная', 'обалденная'], name_eng: 'A.v.e.n.u.e', point: [59.9,30.3], carte: ['Беллини', 'Александр', 'Мохито'], recs: ['Александр', 'Мохито']}
	],
	
	'Омск':
	[
		{name: '7 вечера', format: ['уютная', 'обалденная'], name_eng: 'At Seven o\'Clock', point: [55,73.4], carte: ['Беллини', 'Александр', 'Мохито'], recs: ['Александр', 'Мохито']},
