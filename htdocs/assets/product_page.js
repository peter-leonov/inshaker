...
(function() {
  $(function() {
    var COCKTAIL_TPL, cocktail, cocktails, cocktailsContainer, _i, _j, _len, _len1, _ref, _ref1;

    COCKTAIL_TPL = function(cocktail, alcohol) {
      if (!cocktail) {
        return "";
      }
      return "<li class='" + (alcohol ? 'alcohol' : 'nonalcohol') + "'>\n<a href='" + cocktail.legacyUri + "'>\n    <div class='image'><img src='" + cocktail.imageUrl + "'></div>\n    <div class='name'>" + cocktail.name + "</div>\n</a>\n</li>";
    };
    cocktailsContainer = $("#coctails");
    cocktails = "";
    _ref = InPageCahchedData.alcoholic_cocktails;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      cocktail = _ref[_i];
      cocktails += COCKTAIL_TPL(cocktail, true);
    }
    _ref1 = InPageCahchedData.non_alcoholic_cocktails;
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      cocktail = _ref1[_j];
      cocktails += COCKTAIL_TPL(cocktail, false);
    }
    cocktailsContainer.html(cocktails);
    $(".filter").on("click", "a", function() {
      var filterClass, target;

      target = $(this);
      filterClass = target.attr("data-filter") || "all";
      cocktailsContainer.removeClass("alcohol nonalcohol all").addClass(filterClass);
